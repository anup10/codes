...
{
       2,    10,     3,     3,     4,     4,     9,     0,    10,     5,
       5,     7,     8,    12,     0,     0,    13,    14,     9,     0,
      10,     0,     0,    11
};
...
{
       0,     6,     3,     3,     5,     5,     4,    -1,     6,    10,
      10,     4,     5,    11,    -1,    -1,     9,    10,     4,    -1,
       6,    -1,    -1,     9
};
...
/* Line 1806 of yacc.c  */
#line 47 "cal2.y"
    {(yyval.nptr)=makeLeaf((yyvsp[(1) - (1)].val));}
    break;
...
/* Line 1806 of yacc.c  */
#line 48 "cal2.y"
    {(yyval.nptr)=makeNode('+',(yyvsp[(1) - (3)].nptr),(yyvsp[(3) - (3)].nptr));}
    break;
...
/* Line 1806 of yacc.c  */
#line 51 "cal2.y"
    {(yyval.nptr)=makeUnary('-',(yyvsp[(2) - (2)].nptr));}
    break;
